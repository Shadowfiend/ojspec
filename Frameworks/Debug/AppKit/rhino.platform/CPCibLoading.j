I;21;Foundation/CPBundle.jI;25;Foundation/CPDictionary.jI;21;Foundation/CPString.jc;2555;
...
{ with(self)
{
    ...
    LoadInfoForCib[objj_msgSend(cib, "hash")] = { loadDelegate:aDelegate, externalNameTable:aNameTable };
}
})]);
...
{ with(self)
{
    var loadInfo = LoadInfoForCib[objj_msgSend(aCib, "hash")];
    delete LoadInfoForCib[objj_msgSend(aCib, "hash")];
