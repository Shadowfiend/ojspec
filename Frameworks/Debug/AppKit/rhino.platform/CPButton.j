i;21;_CPImageAndTextView.ji;12;CGGeometry.ji;11;CPControl.jc;21255;
...
{ with(self)
{
    switch (buttonType)
    {
        ...
        case CPOnOffButton: objj_msgSend(self, "setHighlightsBy:", CPChangeBackgroundCellMask);
                                        objj_msgSend(self, "setShowsStateBy:", CPChangeBackgroundCellMask);
                                        break;
        case CPToggleButton: objj_msgSend(self, "setHighlightsBy:", CPPushInCellMask | NSContentsCellMask);
